let foods = [
    ...
    },
    {
        ...
        price: 279,
        category: "Biryani",
        img: "https://coppertampa.com/wp-content/uploads/2025/03/Hyderabadi-Chicken-Dum-Biryani-600x600.webp",
    },
    {
        id: 6,
        name: "Egg Biryani",
    ...
    },
    {
        ...
        price: 99,
        category: "Desserts",
        img: "https://www.recipescrock.com/wp-content/uploads/2025/05/fudgy-chocolate-brownie-recipe-easy-one-bowl.jpg",
    },
    {
        id: 10,
    ...
    },
    {
        ...
        price: 119,
        category: "Drinks",
        img: "https://img.freepik.com/premium-photo/fruit-punch-white-background_827055-378.jpg",
    },
    {
        id: 13,
...
function displayFood() {
 let item = document.getElementById('food-item');
 item.innerHTML = filterFood.map(food => `
 <div class="food-card">
...
function addToCart(id){
 ...
 let selectedFood = foods.find(food => food.id === id);
...
function applyFilter(){
 ...
 filterFood =foods.filter((f)=>{
 let matchingCategory = cat === "All" ||foods.filter((f)=> f.category === cat);
